...
public class GameTest {
    ...
    public void shouldFindUnregisteredFirstPlayer() {
        ...
        Assertions.assertThrows(NotRegisteredException.class, () -> game.round("Alex", player3.getName()));
    }
    ...
    public void shouldFindUnregisteredSecondPlayer() {
        ...
        Assertions.assertThrows(NotRegisteredException.class, () -> game.round(player2.getName(), "Anna"));
    }
